...
$(function() {
    function Emc2101TabViewModel(parameters) {
        ...
        self.formatTempCText = function (temperature) {
            return Number.parseFloat(temperature).toFixed(0)+ "°C";

        }
        self.formatTempFText = function (temperature) {
            return self.cToF(Number.parseFloat(temperature)).toFixed(0) + "°F";
